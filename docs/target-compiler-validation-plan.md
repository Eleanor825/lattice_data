...
Phase 1 should eventually compare against simple baselines:
...
- the current branch mainly provides fixture-backed acceptance and regression evidence rather than formal baseline comparison tables.
...
- the branch now also includes a machine-readable benchmark artifact generated by `scripts/benchmark_target_compiler.py`.
